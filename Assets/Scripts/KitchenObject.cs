...
{
    [SerializeField] private KitchenObjectSO kitchenObjectSO; // Reference to the ScriptableObject containing data for this kitchen object

    private IKitchenObjectParent kitchenObjectParent; // Reference to the parent object that holds this kitchen object
